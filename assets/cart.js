/* ==========================================================================
   ...
   스마트스토어 결제 API가 아닌 주문 목록 장바구니입니다.
   결제와 재고 확인은 각 제품의 외부 스토어에서 진행합니다.
   ========================================================================== */
(function () {
  'use strict';
  ...
  function orderText() {
    ...
    return parts.join(', ') + ' (합계 ' + won(total) + ')';
  }
  ...
  function init() {
    ...
    document.addEventListener('keydown', function (e) {
      ...
      for (var i = 0; i < focusable.length; i++) {
        if (focusable[i].offsetWidth || focusable[i].offsetHeight) list.push(focusable[i]);
      }
